...
; -----------------------------------------------------------------------------
    ...
    RPT_NL   DB 0DH, 0AH, '$'
    RPT_N_VAL_BCD1 DB '  VAL_BCD1 = ', '$'
    RPT_N_VAL_BCD2 DB '  VAL_BCD2 = ', '$'
    RPT_N_RES_SUM DB '  RES_SUM = ', '$'
    RPT_N_RES_CARRY DB '  RES_CARRY = ', '$'
.CODE
MAIN PROC
