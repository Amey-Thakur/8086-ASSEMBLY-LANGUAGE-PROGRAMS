...
; DESCRIPTION: A program that retrieves the current system date from DOS and 
;              displays it in DD/MM/YYYY format.
...
; TECHNICAL NOTES
; =============================================================================
; 1. SYSTEM CLOCK: DOS keeps track of date using BIOS Real-Time Clock chip.
;    Function 2AH is the high-level way to access this data.
